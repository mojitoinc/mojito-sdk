...
import { MojitoMixerTheme } from '../theme';

const MixersLayout = () => {
  const { isAuthenticated, getIdTokenClaims, loginWithPopup, logout } = useAuth0();
  ...
  return (
    <div>
        ...
        <Button disabled={ !isAuthenticated } onClick={ openModal }>
            Open Mixers
        </Button>
        { isAuthenticated && (
        <MojitoCheckout
